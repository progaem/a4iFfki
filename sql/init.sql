...
comment on column messages.chat_id is 'The chat ID';
comment on column messages.invoking_user_id is 'The user ID of a peron who invoked give achievement command';
comment on column messages.target_user_id is 'The user ID of a person who was targeted for an achievement';
comment on column messages.message_text is 'The message text';
comment on column messages.message_text is 'Detected prompt text (null if the prompt was unknown)';
comment on column messages.timestamp is 'The timestamp of the message'
...
comment on column chat_achievements.sticker_pack_owner_id us 'The user ID of owner of sticker pack'
...
comment on column chat_achievements.sticker_id is 'Telegram sticker id (not a primary since two different stickers might have the same id in telegram)'
comment on column chat_achievements.type is '(\'achievement\', \'description\', \'profile\', \'profile_description\'or \'empty\')';
comment on column chat_achievements.index_in_sticker_pack is 'The index of sticker in sticker pack'
comment on column chat_achievements.chat_id is 'The user ID'
comment on column chat_achievements.chat_id is 'The chat ID'
comment on column chat_achievements.user_sticker_pack_name is 'The name of the sticker pack'
comment on column chat_achievements.file_path is 'Path to the sticker file source'
