    ...
    async def generate_image(self, achievement_text: str) -> Image:
        ...
        try:
            ...
            raise StickerGeneratorError(
                "Problem appeared during Google Translate API invocation", "google-api", str(e)) from e
        ...
        prompt = (
            ...
            f'color palette. Include a symbolic element, like a trophy, to signify the achievement. '
            f'The background should be white to emphasize the sticker format')
